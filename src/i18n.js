    ...
    en: {
        translation: {
            ...
            "about": {
                ...
                "projectscontent1": "API-CRI: Final-year project at Covage, a Django service integrated with the entire Covage environment for processing fiber optic technician intervention reports. Full project management, coordination with external developers, personal development, and deployment (Django, REST, CI/CD) at Covage",
                "projectscontent2": "Leyanda: Current CESI project involving advanced AI techniques including image classification, autoencoders, and image captioning using TensorFlow (Python, TensorFlow, Computer Vision) at CESI",
                "projectscontent3": "Memore: Personal project to create a home-based Jarvis-like AI assistant hosted on a repurposed PC, using open-source AI with a custom memory system and Sesame AI voice output. Planned to be developed with PyTorch (Python, PyTorch, NLP) personal project",
                "projectscontent4": "Kosc Platform: Telecom workflow management platform integrating various Covage business processes (Django, Angular, Event-driven architecture) at Covage",
                "projectscontent5": "MyEWay-DW: ETL pipelines and data warehouse architecture for sports analytics platform (Airflow, ClickHouse, Express.js) at TurkuAMK",
                "projectscontent6": "GASTON: ML-based ticketing classification system for telecom network issues (PyTorch, Django) at Covage",
                "projectscontent7": "Elifibre Interco BSB: Fiber optic eligibility assessment system for business clients (C# .NET, Ajax) at Covage",
                "projectscontent8": "Eat'Em: Microservices-based food delivery platform (React, Node.js, Kubernetes) at CESI",
                "projectscontent9": "FoxStats: Game data analytics platform for Foxhole (Django, Angular) personal project",
                "projectscontent10": "GolChess: Chess engine with reinforcement learning capabilities (Python) personal project",
                "projectscontent11": "ADEME: Advanced pathfinding algorithm for eco-friendly routing (Python) at CESI",
                "projectscontent12": "CHU: Healthcare data analytics pipeline for hospital resource optimization (Talend, Hive, PowerBI) at CESI",
                "projectscontent13": "RALab: Automated spectrometry lab report generation system (VBA/Excel) at ArianeGroup",
                "projectscontent14": "EasySave: Enterprise file backup solution with encryption and compression (C# .NET) at CESI",
                "projectscontent15": "ABSTERGO SI: Enterprise information systems architecture design (System Administration) at CESI",
                "projectscontent16": "Funkytown: Urban network architecture for municipal services (System Administration, Networking) at CESI",
                "projectscontent17": "StrongBox: Security-focused embedded system for valuables storage (C Arduino) at CESI",
                "projectscontent18": "ViteMonStage: Internship matching platform for students (Native PHP) at CESI"
            }
        }
    },
    fr: {
        translation: {
            ...
            "about": {
                ...
                "projectscontent2": "Leyanda : Projet actuel au CESI impliquant des techniques avancées d'IA, notamment la classification d'images, les autoencodeurs et le captioning d'images avec TensorFlow (Python, TensorFlow, Vision par ordinateur) au CESI",
                "projectscontent3": "Memore : Projet personnel visant à créer un assistant IA type Jarvis pour la maison, hébergé sur un PC réutilisé, utilisant une IA open-source avec un système de mémoire personnalisé et une sortie vocale via Sesame AI. Prévu pour être développé avec PyTorch (Python, PyTorch, NLP) projet personnel",
                "projectscontent4": "Plateforme Kosc : Plateforme de gestion des flux télécom intégrant les processus métier de Covage (Django, Angular, Architecture événementielle) chez Covage",
                "projectscontent5": "MyEWay-DW : Pipelines ETL et architecture d'entrepôt de données pour plateforme d'analyse sportive (Airflow, ClickHouse, Express.js) à TurkuAMK",
                "projectscontent6": "GASTON : Système de classification de tickets basé sur ML pour les problèmes réseau télécom (PyTorch, Django) chez Covage",
                "projectscontent7": "Elifibre Interco BSB : Système d'évaluation d'éligibilité à la fibre optique pour clients professionnels (C# .NET, Ajax) chez Covage",
                "projectscontent8": "Eat'Em : Plateforme de livraison de repas basée sur les microservices (React, Node.js, Kubernetes) au CESI",
                "projectscontent9": "FoxStats : Plateforme d'analyse de données de jeu pour Foxhole (Django, Angular) projet personnel",
                "projectscontent10": "GolChess : Moteur d'échecs avec capacités d'apprentissage par renforcement (Python) projet personnel",
                "projectscontent11": "ADEME : Algorithme avancé de recherche de chemin pour routage écologique (Python) au CESI",
                "projectscontent12": "CHU : Pipeline d'analyse de données de santé pour l'optimisation des ressources hospitalières (Talend, Hive, PowerBI) au CESI",
                "projectscontent13": "RALab : Système de génération automatisée de rapports de laboratoire de spectrométrie (VBA/Excel) chez ArianeGroup",
                "projectscontent14": "EasySave : Solution de sauvegarde de fichiers d'entreprise avec chiffrement et compression (C# .NET) au CESI",
                "projectscontent15": "ABSTERGO SI : Conception d'architecture de systèmes d'information d'entreprise (Administration système) au CESI",
                "projectscontent16": "Funkytown : Architecture réseau urbaine pour services municipaux (Administration système, Réseaux) au CESI",
                "projectscontent17": "StrongBox : Système embarqué orienté sécurité pour stockage d'objets de valeur (C Arduino) au CESI",
                "projectscontent18": "ViteMonStage : Plateforme de mise en relation pour stages étudiants (PHP natif) au CESI"
            }
        }
    }
};
